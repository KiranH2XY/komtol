...
def main():
    ...
    ip = input(stage(f"Masukkan IP Server Gta Samp {purple}->{fluo2} ", '?'))
    print()
    ...
    port = input(stage(f"Masukkan Port {purple}[{white}press {fluo2}enter{white} to attack all ports{purple}] {purple}->{fluo2} ", '?'))
    print()
    ...
    force = input(stage(f"Masukkan packet {purple}[{white}press {fluo2}enter{white} for 1250{purple}] {purple}->{fluo2} ", '?'))
    print()
    ...
    print(stage(f"Tols By Kiran Samp {fluo2}{ip}{cport}{white}."), end='\r')
